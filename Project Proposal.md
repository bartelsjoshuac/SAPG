...
#### OpenLDAP is written in C and runs on any platform which has a C compiler.  It is provided as source code only.  However, there are [binary packages available](https://www.openldap.org/faq/data/cache/108.html from thir parties.
